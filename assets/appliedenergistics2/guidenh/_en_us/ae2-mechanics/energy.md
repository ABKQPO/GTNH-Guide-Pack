...
its own unit, AE. This conversion is one-way. Energy can be converted by <ItemLink id="appliedenergistics2:tile.BlockEnergyAcceptor" showIcon="left" />s and
...
The <ItemLink id="appliedenergistics2:tile.BlockCreativeEnergyCell" showIcon="left" /> is a late-game item providing UNLIMITED POWAHHHH or whatever.
